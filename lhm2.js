...
let urls = require('./URLlist2.json'); // The file where your list of urls lives
let runs = 0
let cron_url = "http://10.10.224.221/cron/-GKYUCGhx8VfsaKjjLLo-_Hm8pwLkvFZXJIGRoQPT_VkjNbYJzNbxDTEqo6lnsEYF0qJ04oKOg"
try {
